...
array{
		...
		bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_1\\Symbol_002.jpeg"; width = 180; height=180;}target_2;
		bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_1\\Symbol_003.jpeg"; width = 180; height=180;}target_3;
		bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_1\\Symbol_004.jpeg"; width = 180; height=180;}target_4;
		bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_1\\Symbol_005.jpeg"; width = 180; height=180;}target_5;
		bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_1\\Symbol_006.jpeg"; width = 180; height=180;}target_6;
		bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_1\\Symbol_007.jpeg"; width = 180; height=180;}target_7;
		bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_1\\Symbol_008.jpeg"; width = 180; height=180;}target_8;
		bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_1\\Symbol_009.jpeg"; width = 180; height=180;}target_9;
	} targets;
...
trial{
	...
	stimulus_event {
		picture{
			...
			x = -480; y = 260;
			bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_2\\Symbol_002.jpeg"; width=100; height=100;} graphic_2;
			x = -360; y = 260;
			bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_3\\Symbol_003.jpeg"; width=100; height=100;} graphic_3;
			x = -240; y = 260;
			bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_4\\Symbol_004.jpeg"; width=100; height=100;} graphic_4;
			x = -120; y = 260;
			bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_5\\Symbol_005.jpeg"; width=100; height=100;} graphic_5;
			x = 0; y = 260;
			bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_6\\Symbol_006.jpeg"; width=100; height=100;} graphic_6;
			x = 120; y = 260;
			bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_7\\Symbol_007.jpeg"; width=100; height=100;} graphic_7;
			x = 240; y = 260;
			bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_8\\Symbol_008.jpeg"; width=100; height=100;} graphic_8;
			x = 360; y = 260;
			bitmap {filename = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_9\\Symbol_009.jpeg"; width=100; height=100;} graphic_9;
			x = 480; y = 260;
...
if input == "ver1" then
		inst_text.set_caption ("In der folgenden Aufgabe wird Ihnen am oberen Bildschirmrand eine Legende angezeigt.\n Diese beinhaltet Zahlen von 1 bis 9. Unter jeder dieser Zahlen ist ein Symbol zu sehen.\nDie Zahlen und die Symbole bilden Paare. \nAm unteren Bildschirmrand wird ebenfalls eine Zahl und ein Symbol zu sehen sein.\n Ihre Aufgabe wird es sein, zu beurteilen, ob die Paarung von Zahl und Symbol\nder in der Legende entspricht. Dazu drücken Sie die Taste M, wenn die Paarung \ngenau wie in der Legende ist, und die Taste Y, wenn die Paarung ungleich ist.\n Am besten lassen Sie die Zeigefinger einfach auf den Tasten liegen. \nVersuchen Sie so schnell wie möglich zu antworten ohne einen Fehler zu machen.\n Die Aufgabe beinhaltet 9 Blocks. Nach jedem Block haben Sie eine kleine Pause \nund die Symbole, die Sie beurteilen sollen, ändern sich.\n\n\n Der Versuch beginnt mit Druck der Leertaste.");
elseif input == "ver2" then
		inst_text.set_caption ("In der folgenden Aufgabe wird Ihnen am oberen Bildschirmrand eine Legende angezeigt.\n Diese beinhaltet Zahlen von 1 bis 9. Unter jeder dieser Zahlen ist ein Symbol zu sehen.\nDie Zahlen und die Symbole bilden Paare. \nAm unteren Bildschirmrand wird ebenfalls eine Zahl und ein Symbol zu sehen sein.\n Ihre Aufgabe wird es sein, zu beurteilen, ob die Paarung von Zahl und Symbol\nder in der Legende entspricht. Dazu drücken Sie die Taste Y, wenn die Paarung \ngenau wie in der Legende ist, und die Taste M, wenn die Paarung ungleich ist.\n Am besten lassen Sie die Zeigefinger einfach auf den Tasten liegen. \nVersuchen Sie so schnell wie möglich zu antworten ohne einen Fehler zu machen.\n Die Aufgabe beinhaltet 9 Blocks. Nach jedem Block haben Sie eine kleine Pause \nund die Symbole, die Sie beurteilen sollen, ändern sich.\n\n\n Der Versuch beginnt mit Druck der Leertaste.");
end;
...
int block_duration = 90000;

string path = "C:\\Users\\neuro-forschung\\Desktop\\MS-tDCS\\Stimuli\\Set_";
	
loop int q = 1 until q > nr_sets
begin
	
	string set_name = string(pres_order[1][1][q]);
	
	graphic_1.set_filename (path+set_name+"\\Symbol_001.jpeg");
	graphic_1.load();
	graphic_2.set_filename (path+set_name+"\\Symbol_002.jpeg");
	graphic_2.load();
	graphic_3.set_filename (path+set_name+"\\Symbol_003.jpeg");
	graphic_3.load();
	graphic_4.set_filename (path+set_name+"\\Symbol_004.jpeg");
	graphic_4.load();
	graphic_5.set_filename (path+set_name+"\\Symbol_005.jpeg");
	graphic_5.load();
	graphic_6.set_filename (path+set_name+"\\Symbol_006.jpeg");
	graphic_6.load();
	graphic_7.set_filename (path+set_name+"\\Symbol_007.jpeg");
	graphic_7.load();
	graphic_8.set_filename (path+set_name+"\\Symbol_008.jpeg");
	graphic_8.load();
	graphic_9.set_filename (path+set_name+"\\Symbol_009.jpeg");
	graphic_9.load();
	
	target_1.set_filename (path+set_name+"\\Symbol_001.jpeg");
	target_1.load();
	target_2.set_filename (path+set_name+"\\Symbol_002.jpeg");
	target_2.load();
	target_3.set_filename (path+set_name+"\\Symbol_003.jpeg");
	target_3.load();
	target_4.set_filename (path+set_name+"\\Symbol_004.jpeg");
	target_4.load();
	target_5.set_filename (path+set_name+"\\Symbol_005.jpeg");
	target_5.load();
	target_6.set_filename (path+set_name+"\\Symbol_006.jpeg");
	target_6.load();
	target_7.set_filename (path+set_name+"\\Symbol_007.jpeg");
	target_7.load();
	target_8.set_filename (path+set_name+"\\Symbol_008.jpeg");
	target_8.load();
	target_9.set_filename (path+set_name+"\\Symbol_009.jpeg");
	target_9.load();
	...
	double percentage_right = decimal_right*100;
	
	if q == 9 then
		intertrial_text.set_caption ("Sehr gut, Sie haben Block " + string(q) + " von 9 geschafft. \n Dabei haben Sie " + string(round(percentage_right,0)) + "% der Paarungen richtig bewertet. \n\n\n Vielen Dank für ihre Teilnahme.");
		intertrial_text.redraw();
		system_keyboard.set_time_out(2000);
		intertrial2.present();
		intertrial.present();
	
	else
		loop int i = 60 until i < 0
		begin
			intertrial_text.set_caption ("Sehr gut, Sie haben Block " + string(q) + " von 9 geschafft. \n Dabei haben Sie " + string(round(percentage_right,0)) + "% der Paarungen richtig bewertet. \n Sie können noch " + string(i) + " Sekunden pausieren. \n\n\n Die Aufgabe wird durch Druck der Leertaste fortgeführt.");
			intertrial_text.redraw();
